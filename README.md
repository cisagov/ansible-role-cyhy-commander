...
|----------|-------------|---------|----------|
| cyhy\_commander\_cyhy\_core\_version | The version of cisagov/cyhy-core to use; must be a valid git reference. | [Omitted](https://docs.ansible.com/ansible/latest/user_guide/playbooks_filters.html#making-variables-optional) | No |
